...
class _Api implements Api {
  ...
  Future<AddBusinessResponse> addBusiness(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AddBusinessResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final value = AddBusinessResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<AllBusinessInfoResponse> getAllBusiness(String contentType) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Content-Type': contentType};
    _headers.removeWhere((k, v) => v == null);
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AllBusinessInfoResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final value = AllBusinessInfoResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<PricingResponse> savePrice(
    ...
    _data.addAll(request.toJson());
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<PricingResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final value = PricingResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<HomeFeedResponse> homeFeed(
    ...
    _data.addAll(request.toJson());
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<HomeFeedResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final value = HomeFeedResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<AllMatchesResponse> getAllMatchesUnderBusiness(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<AllMatchesResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final value = AllMatchesResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<MatchDetailResponse> getMatchDetails(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<MatchDetailResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final value = MatchDetailResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<MyBookingResponse> getClientBooking(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<MyBookingResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final value = MyBookingResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<FriendRes> findFriends(
    ...
    _data.addAll(body.toJson());
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<FriendRes>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
            ...
            .compose(
              _dio.options,
              'client/nearby-friend-suggestion',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    final value = FriendRes.fromJson(_result.data!);
    return value;
  }
  ...
  Future<FollowerRes> getFollower(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<FollowerRes>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final value = FollowerRes.fromJson(_result.data!);
    return value;
  }

  @override
  Future<SimpleResponse> follow(
    String contentType,
    FollowReq body,
  ) async {
    final _extra = <String, dynamic>{};
